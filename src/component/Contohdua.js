...
[14.50, 13/12/2021] Bg Sandi Paytren: import React from 'react';
import Container from '@mui/material/Container';
import Typography from '@mui/material/Typography'
import Box from '@mui/material/Box'
import Grid from '@mui/material/Grid'
...
function App() {
  ...
  var dataCustomer = [
    {
      id: 1,
      icon: "https://demo.epic-webdesign.com/tf-smart/v1/images/ui-design.png"
    },
    {
      id: 2,
      icon: "https://demo.epic-webdesign.com/tf-smart/v1/images/ui-design.png"
            ...
            <Stack direction="row" spacing={5}>
              {dataCustomer.map(item => (
                <Paper key={item.id} sx={{ padding: 3 }}>
                  <img src={item.icon} alt="gambar-home" style={{ height: 100, maxWidth: 100 }} />
                </Paper>
              ))}
            </Stack>
            <Stack direction="row" spacing={5}>
